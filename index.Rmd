...
---
## Modelando a característica de um dipolo

Este *post* é baseado em uma atividade apresentada no livro [*“Physique-Chimie 2de”*]([https://www.calameo.com/books/0005967298a6f595a36e9]) de Lionel Douthe, Baptiste Fray publicado por Lelivrescolaire.fr Éditions. Tanto o texto apresentado sobre como a atividade aparecem no livro nas páginas [314 e 315](https://www.lelivrescolaire.fr/page/6225425). A tradução do texto foi nossa em comlaboração com o ChatGPT.
...
Veja mais sobre [George Simon Ohm](https://www.youtube.com/watch?v=ouaUdZTu0x8&t=15s):
...
1. Represente este conjunto de pontos U=f(I) usando a linguagem de programação Python, utilizando símbolos "+" de cor azul.
