...
5. cat("O martelo levaria aproximadamente", round(t, 2), "segundos para alcançar o solo na Lua."): 
Por fim, exibimos o resultado calculado. O tempo é arredondado para duas casas decimais e apresentado em segundos. Neste caso, o martelo levaria aproximadamente X segundos para alcançar o solo na Lua.
...
3. cat("O título do livro é", round(TF, 0), "."): Por fim, exibimos o resultado calculado. A frase “O título do livro é” é seguida pelo valor da temperatura em Fahrenheit, arredondado conforme necessário. Neste caso, o resultado seria algo como “O título do livro é 451.4.” (dependendo do arredondamento).
