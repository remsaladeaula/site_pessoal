...
3. cat("O título do livro é", round(TF, 0), "."): Por fim, exibimos o resultado calculado. A frase “O título do livro é” é seguida pelo valor da temperatura em Fahrenheit, arredondado conforme necessário. Neste caso, o resultado seria algo como “O título do livro é Fahrenheit 451.”.
...
3. **Coeficiente Quadrático**:
    ...
    ![](bola3.png){width=30cm, height=15cm}
